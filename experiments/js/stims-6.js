...
var stories = [
  ...
  {
    story: "dissolve",
    storyline:  "You are an astronaut-scientist exploring a distant planet. On this planet, there are rocks called CATEGORY and your team of scientists wants to figure out what makes CATEGORY dissolve into particles. Your team runs experiments trying to make CATEGORY dissolve with different chemical compounds.",
    treatment: "compound",
    target: "makes the rocks dissolve",
    query: "make the rocks dissolve",
    past: "dissolved",
    evidence: "had dissolved",
    unit: "rocks"
  },
  {
    story: "blink",
